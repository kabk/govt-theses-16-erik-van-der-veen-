...
o ____________ O ____________ o
<br>
/ // /// //// E R I K v a n d e r V E E N \\\\ \\\ \\ \
<br>
/ // /// //// S H A K I N G F U T U R E S N O W G L O B E S \\\\ \\\ \\ \
<br>
...
<br>
Speculative design is a design niche that uses speculation to come up with possible futures. This type of design has recently been getting more and more attention. Partially, this is due to the increase in publications on the topic, partially because of the present-day issues it taps into. The acceleration of technological innovations and the connected environmental costs raise questions about our future. Questions about the impact of these changes on society, but also questions about the new roles and practices of design in general and graphic design in particular. Speculative design can make future speculations and use design to exhibit those, or use design to trigger the viewer to start contemplating the future. These speculations could for instance function as suggestions, warnings and/or critiques. 
<br>
Although speculative design in the general design field has been discussed extensively, the possibilities of speculative practices in the field of graphic design have been less defined. This could be important for graphic design, for it is still struggling to get rid of its commercial and practical character. 
<br>
The future is inevitably uncertain. That’s why people have always been wanting to uncover it. In the past, this used to be the job of prophets, seers and soothsayers. With their predicting visions they provided people with certainty and hope. Eventually, scientists and writers also got interested in envisioning the future. The most famous examples of scientific future prospects come from utopic and dystopic novels. These historical examples are interesting sources for designers to study not only the function of speculation, but also the methods used and perspectives taken. The same goes for the methods and perspectives that have been talked about in recent writings on speculative design. 
<br>

<br>
What could speculative practices mean for graphic design in particular?
<br>
First of all, the methods used in speculative design could also be used in graphic design—not necessarily only to predict the future, but also in a more general sense to approach problems in a different way or help ideate, inspire and experiment. 
<br>
Secondly, graphic designers could also initiate projects themselves in which they speculate about the future. Graphic design could use storytelling techniques that are unique to the discipline and also use its knowledge about distributing to exhibit ideas. 
<br>
Thirdly, graphic design could use speculation to think of its own future. Times are changing—and so is the profession. Therefore, visionaries are needed to push the discipline into the next era. 
<br>
Lastly, it has to be noted that the boundaries between design disciplines are fading. Therefore, we should abandon the discussion about graphic design as a discipline and start thinking from a more broad design perspective.
</p>

<p class="Pprint">
<br><br><br>
<span class="Hprint">TABLE OF CONTENT</span>
<br>
